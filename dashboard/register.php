...
<head>
  ...
  <title> Diligent Creators  - New Registration
  </title>
  <!--     Fonts and icons     -->
...
<body onload="hideDiv()">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-80 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('https://images.unsplash.com/photo-1499914567823-c240485cb7d1?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&dl=christin-hume-slbqShqAhEo-unsplash.jpg'); background-position: right;">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Welcome!</h1>
            <p class="text-lead text-white">Get your own resume webpage on the Go. Just few clicks and you are done!</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="row px-xl-5 px-sm-4 px-3" hidden>
            ...
            <div class="card-body">
              ...
              <div class="row">
                  ...
                  <div class="col-sm-2">
                    <div class="mb-3">
                      <span id="username_success"><a type="button" class="form-control" id="check_availability" onclick="check_availability()" > <i class="fas fa-mouse"></i> </a></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="row" id="email_div">
                  ...
                  <div class="col-sm-2">
                    <div class="mb-3">
                       <span id="send_otp_success"><a type="button" class="form-control" id="send_otp" onclick="send_otp()" > <i class="fas fa-mouse"></i> </a></span>
                    </div>
                  </div>
                </div>

                <div class="row" id="enter_otp_div">
                  <div class="col-sm-10">
                    <div class="mb-3">
                  ...
                  <div class="col-sm-2">
                    <div class="mb-3">
                      <span id="verify_otp_success"><a type="button" class="form-control" id="verify_otp" onclick="verify_otp()"> <i class="fas fa-mouse"></i> </a></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-check form-check-info text-start" style="text-align:center;">
                    <i class="fas fa-check"></i>
                  <label class="form-check-label" for="flexCheckDefault">
                    I agree the <a href="javascript:;" class="text-dark font-weight-bolder">Terms and Conditions</a>
                  </label>
                </div>
                <span class="form-check-label" id="register_response"></span>

                <div class="text-center">
                  <button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2" onclick="register()" id="register_btn" >Register</button>
                </div>

                <p class="text-sm mt-3 mb-0">Already have an account? <a href="login" class="text-dark font-weight-bolder">Login</a></p>
                <p class="mb-4 text-sm mx-auto">Forgot Password?<a href="reset" class="text-primary text-gradient font-weight-bold">Reset in 20s</a></p>
              </form>
            </div>
          </div>
        </div>
